          ...
          'user_4my3il3TVE5QvTZ2QqykP'
           ...
           (res) => {
            ...
            alert('You message was sent successfully!')
             ...
             (e) => alert("Message was not properly sent. Please try again."))
      ...
      <Form onSubmit={onSubmit}>
        ...
        <Form.Row>
          <Form.Group controlId="exampleForm.ControlTextarea1">
            ...
            <Form.Control className="w-100" cols="140" as="textarea" rows="5" placeholder="Add a brief message" value={message} onChange={(e) => setMessage(e.target.value)} />
          </Form.Group>
        </Form.Row>
