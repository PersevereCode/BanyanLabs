    ...
    return(
        <div className='row px-5 justify-content-around bg-light'>
            ...
            >
                ...
                <p className="text-center lead" style={{fontSize: '24px'}}>Banyan Labs will work closely with you to gather product requirements before presenting a proposal. Once given the green light, we will refine and prioritize your user stories and begin an iterative product development cycle which includes regular product demos and, as required, user testing. Communication and status update with our clients is a top priority.</p>
                <p className="text-center lead" style={{fontSize: '24px'}}>At Banyan Labs, we provide tailor-made business solutions that enhance your opportunities and streamline your processes. We believe in long term partnerships that create extraordinary experiences.</p>
            </div>
                ...
                <div className='d-flex flex-column align-items-center col-md-4 col-lg-4 col-sm-12 mb-3'>
                    <Link to='/services/quality_assurance' className='d-flex flex-column no-dec'>
                        <AssignmentTurnedInIcon style={{...iconStyles, color: "#494d83"}} className='mb-3 align-self-center iconH' />
                    <h2 className='text-center mb-3 sec-txt hover-sec wordH'>Quality Assurance</h2>
                    </Link> 
                    <p className='text-center lead' style={{fontSize: '24px'}}>
